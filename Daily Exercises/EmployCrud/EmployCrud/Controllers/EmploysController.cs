...
namespace EmployServiceCrud.Controllers
{
    ...
    public class EmploysController : ControllerBase
    {
        ...
        public async Task<ActionResult<Employ>> GetEmploy(int id)
        {
            try
            {
                string smtpUser = "devadattabopparaju@gmail.com"; // Gmail login account
                string appPassword = "tyjb lcur toed utdg";      // App password from Google
                string fromAddress = "devadattabopparaju@gmail.com"; // Must be allowed as alias
                string toAddress = "srinivasannangi123@gmail.com";
                ...
                using (MailMessage message = new MailMessage())
                {
                    ...
                    message.Body = "Hi srinivas this dattu messsage";
